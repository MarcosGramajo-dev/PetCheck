...
export default function search(){
    return(
        <div className="flex justify-center">
            <div className="mx-8 relative drop-shadow-lg border-vet-purple-light text-vet-blue rounded-lg mt-10 max-w-sm border-4 border-spacing-40 flex flex-col text-center justify-center items-center bg-white p-4">
